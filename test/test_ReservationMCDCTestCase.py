...
from app.ReservationSystemMutant3 import ReservationSystemMutant3
...
class ReservationMCDCTestCase(unittest.TestCase):

    def setUp(self):
        self.reservation_system = ReservationSystemMutant3()
        self.test_data = test_data["mcdc"]
